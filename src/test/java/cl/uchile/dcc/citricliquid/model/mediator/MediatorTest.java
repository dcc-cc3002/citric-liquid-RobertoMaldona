...
class MediatorTest {
    ...
    private List<Function<Integer, Mediator.MediatorPanel<IPanel>>> panelSuppliers;
    ...
    public void testAddPanel() {
        ...
        int expectedSize = 0;
        for (Function<Integer, Mediator.MediatorPanel<IPanel>> supplier : panelSuppliers) {
    ...
    public void testNormaGoal() {
        ...
        var player = mediator.createPlayer(panel, testPlayers.get(random.nextInt(testPlayers.size())))
                .getFirst();
        assertEquals(new StarNorma(), player.getNormaGoal(),
                "Players should begin with a star norma goal");
        mediator.setNormaGoal(new WinsNorma());
        assertEquals(new WinsNorma(), player.getNormaGoal());
        mediator.setNormaGoal(new StarNorma());
        assertEquals(new StarNorma(), player.getNormaGoal());
    }
    ...
    public void testMeetPlayer() {
        var panels = new Mediator.MediatorPanel<IPanel>[]{
